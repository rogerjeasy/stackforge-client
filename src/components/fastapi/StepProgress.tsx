  ...
  return (
    <TooltipProvider>
      <div className="w-full mb-8 sm:mb-12">
                    ...
                    <div className="flex flex-col items-center cursor-help">
                      <div
                        className={cn(
                          ...
                          isCompleted && "bg-gradient-to-r from-[#FF6B35] to-[#F7931E] text-white shadow-lg",
                          isCurrent && "bg-gradient-to-r from-[#FF6B35] to-[#F7931E] text-white ring-4 ring-[#FF6B35]/20 shadow-lg",
                      ...
                      {/* Step Info - Hidden on mobile, shown via tooltip */}
        ...
        {/* Mobile Step Info - Alternative display */}
